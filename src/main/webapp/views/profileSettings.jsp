	...
	<div class="container-fluid p-0">
		<nav class="navbar navbar-expand-lg navbar-light bg-primary">
			<div class="container-fluid">
				...
				<a class="navbar-brand" href="/eea/home/<%= session.getAttribute("accountId")%>">Home</a> 
					...
					<form action="/eea/update" method="post"
						...
						<div class="form-group d-flex justify-content-center">
							<div class="d-flex justify-content-center align-items-center">
								<label for="selectPic"> <img
									class="btn-outline-danger" src="../static/add-image.png"
									alt="Add Image" />
								</label> 
								<input name="accountImage" id="selectPic" type="file"
